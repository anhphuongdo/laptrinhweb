            ...
            <nav class="navbar navbar-expand navbar-light fixed-top">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active dropdown"><a class="nav-link drop-btn" href="../LaptrinhWeb/View/booklist.php?tl=2">SÁCH HỌC NGOẠI NGỮ</a>
                        ...
                        <li class="nav-item active dropdown"><a class="nav-link drop-btn" href="../LaptrinhWeb/View/booklist.php?tl=5"> SÁCH VĂN HỌC</a>
                            <div class="dropdown-menu">
